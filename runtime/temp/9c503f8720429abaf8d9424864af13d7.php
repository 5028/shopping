<?php /*a:2:{s:76:"D:\phpStudy\PHPTutorial\WWW\shopping\application\admin\view\admin\index.html";i:1561690136;s:71:"D:\phpStudy\PHPTutorial\WWW\shopping\application\admin\view\header.html";i:1561984274;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
	...
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">H-ui.admin</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> <span class="logo navbar-slogan f-l mr-10 hidden-xs">v2.4</span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					<li>超级管理员</li>
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A" style="color: red"><?php echo htmlentities($name); ?></a><i class="Hui-iconfont">&#xe6d5;</i>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="#">个人信息</a></li>
							<li><a href="#">切换账户</a></li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo url('brand/brand'); ?>" data-title="品牌管理" href="javascript:void(0)">品牌管理</a></li>
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo url('role/role'); ?>" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>
					<li><a _href="<?php echo url('permission/permission'); ?>" data-title="权限管理" href="javascript:void(0)">权限管理</a></li>
					<li><a _href="<?php echo url('permission/permission'); ?>" data-title="权限分类管理" href="javascript:void(0)">权限分类管理</a></li>
					<li><a _href="<?php echo url('listt/listt'); ?>" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-tongji">
